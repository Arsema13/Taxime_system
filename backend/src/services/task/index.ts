...
import { addSubtask, toggleSubtask, getSubtasks, updateSubtask, deleteSubtask } from './task-subtask.service';
...
export class TaskService {
  ...
  async getSubtasks(taskId: string) { return getSubtasks(taskId); }
  async updateSubtask(subtaskId: string, data: { title?: string; isCompleted?: boolean }, userId: string) { return updateSubtask(subtaskId, data, userId); }
  async toggleSubtask(subtaskId: string, userId: string) { return toggleSubtask(subtaskId, userId); }
  async deleteSubtask(subtaskId: string) { return deleteSubtask(subtaskId); }
